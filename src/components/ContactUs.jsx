...
const ContactUs = () => {
    ...
    if (data.success) {
      toast.success('Thank you for reaching out to us! We will be in touch as soon as possible')
      event.target.reset();
    } else {
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title title='Reach out to us' desc='We’d love to hear from you. Whether you’re a potential partner, researcher, funder, or community member, get in touch to explore collaboration, ask questions, or learn more about Echo’s work.'/>
