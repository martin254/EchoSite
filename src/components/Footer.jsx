...
const Footer = ({theme}) => {
  return (
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
       ...
       <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        <div className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
            ...
            <ul className='flex gap-8'>
                <li>
                 ...
                 <li>
                    <a className='hover:text-primary' href='#our-work'>Projects</a>
                </li>
                 <li>
        ...
        <div className='text-gray-600 dark:text-gray-400'>
            ...
            <p className='text-sm mt-2 mb-6'>
                Receive the latest News and research about Echo sent to your inbox!
            </p>
       ...
       <hr className='border-b-gray-300 dark:border-gray-600 my-6' />
